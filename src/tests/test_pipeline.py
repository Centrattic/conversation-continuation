...
def test_model_config():
    ...
    print(f"Gemma LoRA targets with MLP: {gemma_config['lora_targets_with_mlp']}")
...
def test_experiment_management():
    ...
    experiment_folder = create_experiment_folder("gemma-3-27b-it", "test_experiment")
...
def test_data_cleaning():
    ...
    try:
        ...
        if data:
            ...
            formatted_data = format_for_training(data[:5])  # Just first 5 for testing
...
def main():
    ...
    print("python src/finetuning/train_lora_unsloth.py --model gemma-3-27b-it --include-mlp --instruct-format")
